...
import 'package:MoonGoAdmin/api/bloc_patterns/warriorPendingListBloc.dart/warrior_pending_list_bloc.dart';
...
class WarriorPendingListPage extends StatefulWidget {
  @override
  _WarriorPendingListPageState createState() => _WarriorPendingListPageState();
}

class _WarriorPendingListPageState extends State<WarriorPendingListPage> {
  final GlobalKey<AnimatedListState> _listKey = GlobalKey<AnimatedListState>();
  final _scrollController = ScrollController();
  final _scrollThreshold = 600.0;
  Completer<void> _refreshCompleter;
  WarriorPendingListBloc _pendingListBloc;

  @override
  void initState() {
    _pendingListBloc = WarriorPendingListBloc(_listKey, _buildRemoveItem);
  ...
  Widget _buildItem(BuildContext context, int index,
    ...
    return SlideTransition(
        ...
        child: BlocProvider.value(
          value: BlocProvider.of<WarriorPendingListBloc>(context),
  ...
  Widget build(BuildContext context) {
    return BlocProvider<WarriorPendingListBloc>(
      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: BlocConsumer<WarriorPendingListBloc, PendingListState>(
